...
<div class="space-y-6">
  ...
  {#if data.promotions.length === 0}
    ...
    <div class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-800 py-24 text-center">
      ...
      <h2 class="text-lg font-black text-neutral-400">No Active Offers</h2>
  ...
  {:else}
    ...
    <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
      {#each data.promotions as promo}
        <div class="rounded-2xl border border-neutral-800 bg-neutral-900/40 overflow-hidden flex flex-col justify-between transition hover:border-neutral-700">
          <div class="p-6 space-y-4">
            ...
            <div class="flex items-center gap-2">
              ...
              {#if promo.bonusAmount > 0}
                <span class="text-xs font-bold text-neutral-400">Up to {formatCurrency(promo.bonusAmount, auth.user?.currency || 'USD')} Bonus</span>
              {/if}
            </div>
          ...
          <div class="border-t border-neutral-800/60 p-4 bg-neutral-950/40 flex items-center justify-between text-[10px] font-bold text-neutral-500">
