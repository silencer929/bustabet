...
<div class="space-y-6">
    ...
    {#if data.notifications.some((n: any) => !n.read)}
      ...
      >
        <Button 
          ...
          class="h-9 border-neutral-800 bg-neutral-900/40 text-xs font-bold text-neutral-400 hover:text-white rounded-lg gap-1.5"
        >
  ...
  {#if data.notifications.length === 0}
    ...
    <div class="flex flex-col items-center justify-center rounded-2xl border border-dashed border-neutral-800 py-24 text-center">
      ...
      <h2 class="text-lg font-black text-neutral-400">All Clear</h2>
    ...
    <div class="space-y-2.5">
      {#each data.notifications as notification}
        <div class="flex items-start justify-between border p-4 rounded-xl transition duration-150
          {notification.read 
            ? 'border-neutral-900 bg-neutral-900/10 text-neutral-400' 
        ...
        >
          <div class="flex items-start gap-3 max-w-[85%]">
            ...
            <div class="space-y-1">
              <div class="text-xs font-bold {notification.read ? 'text-neutral-400' : 'text-neutral-100'}">
                {notification.title}
              </div>
