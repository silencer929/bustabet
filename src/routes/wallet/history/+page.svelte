...
<div class="space-y-6">
  ...
  {#if data.transactions.length === 0}
    <!-- Empty State -->
    <div class="text-center text-xs font-semibold text-neutral-600 py-24 border border-dashed border-neutral-800 rounded-lg">
        ...
        <tbody class="divide-y divide-neutral-800 font-medium">
          {#each data.transactions as tx}
            <tr class="hover:bg-neutral-900/10 transition duration-150">
              ...
              <!-- Date Column -->
              <td class="whitespace-nowrap px-4 py-4 text-neutral-400">
