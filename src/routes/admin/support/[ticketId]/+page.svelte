...
<div class="space-y-6 max-w-4xl mx-auto">
  ...
  <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-neutral-800/80 pb-4">
    <div class="space-y-1">
      <a href="/admin/support" class="inline-flex items-center gap-1.5 text-xs font-bold text-neutral-500 hover:text-white transition mb-1">
      ...
      {#if !isClosed}
        ...
        >
          <Button 
            ...
            variant="outline" 
            class="h-8 text-[9px] font-black border-red-800/80 bg-red-950/10 text-red-400 hover:bg-red-600 hover:text-white px-2.5 gap-1 rounded-lg"
          >
            <Lock class="h-3 w-3" />
            Close Ticket
          </Button>
      ...
      <div class="flex w-full {isAdmin ? 'justify-end' : 'justify-start'}">
        <div class="max-w-[80%] rounded-2xl p-4 space-y-1.5 border
          {isAdmin 
            ...
            : 'bg-neutral-950 border-red-500/20 text-neutral-300 rounded-tl-none'}"
        >
          <div class="flex items-center gap-2">
            <span class="text-[10px] font-black tracking-wide {isAdmin ? 'text-red-400' : 'text-neutral-400'}">
    ...
    >
      ...
      <div class="flex gap-2">
        ...
        <Button 
          ...
          class="h-11 px-5 bg-red-600 hover:bg-red-500 text-white font-black rounded-lg gap-1.5 shadow-md disabled:bg-neutral-800"
        >
          <Send class="h-4 w-4" />
