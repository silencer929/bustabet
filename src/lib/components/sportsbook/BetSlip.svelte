...
<div class="flex h-full w-full flex-col bg-background border-l border-border text-foreground">
  <!-- Header -->
  <div class="flex items-center justify-between border-b border-border px-4 py-3 bg-background/40">
    ...
    {:else}
      {#each betslip.selections as selection}
        <div class="relative rounded-lg border border-border bg-background/40 p-3 shadow-sm">
          ...
          <div class="mt-2.5 flex items-center justify-between border-t border-border/80 pt-2">
  ...
  {#if betslip.count > 0}
    <div class="border-t border-border p-4 bg-background/20 space-y-4">
      <!-- Response Alerts -->
      {#if errorMessage}
      ...
      <div class="space-y-1.5 text-xs font-semibold text-muted-foreground">
        ...
        <div class="flex justify-between border-t border-border/80 pt-1.5">
