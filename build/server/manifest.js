...
return {
	...
	_: {
		client: {start:"_app/immutable/entry/start.BswTBdd9.js",app:"_app/immutable/entry/app.D4DA-hvw.js",imports:["_app/immutable/entry/start.BswTBdd9.js","_app/immutable/chunks/DXdR_0i9.js","_app/immutable/chunks/ByXn1zri.js","_app/immutable/entry/app.D4DA-hvw.js","_app/immutable/chunks/ByXn1zri.js","_app/immutable/chunks/kNaey6uv.js","_app/immutable/chunks/xihTtKlq.js"],stylesheets:[],fonts:[],uses_env_dynamic_public:false},
		nodes: [
			__memo(() => import('./chunks/0-Btqb2eEb.js')),
			__memo(() => import('./chunks/1-BFkiwyP7.js')),
			__memo(() => import('./chunks/2-DoCDZbvD.js')),
			__memo(() => import('./chunks/3-CH3BHKyB.js')),
			__memo(() => import('./chunks/4-DxdeLuvf.js')),
			__memo(() => import('./chunks/5-CfsH47tm.js')),
			__memo(() => import('./chunks/6-CJZYAqs6.js')),
			__memo(() => import('./chunks/7-CPW4jxwx.js')),
			__memo(() => import('./chunks/8-BdwC-QSz.js')),
			__memo(() => import('./chunks/9-B9HsWWMg.js')),
			__memo(() => import('./chunks/10-CfPLG6Hr.js')),
			__memo(() => import('./chunks/11-B26y7g3-.js')),
			__memo(() => import('./chunks/12-Dw3ptmZm.js')),
			__memo(() => import('./chunks/13-D1SG_p78.js')),
			__memo(() => import('./chunks/14-DpoNrU_p.js')),
			__memo(() => import('./chunks/15-CEQw8yeH.js')),
			__memo(() => import('./chunks/16-Dtl1HX_s.js')),
			__memo(() => import('./chunks/17-DHndVlR5.js')),
			__memo(() => import('./chunks/18-ZmIiAWQ8.js')),
			__memo(() => import('./chunks/19-rbC_SlvB.js')),
			__memo(() => import('./chunks/20-BjMLZB0z.js')),
			__memo(() => import('./chunks/21-DPaxpeAJ.js')),
			__memo(() => import('./chunks/22-BaHWVFgy.js')),
			__memo(() => import('./chunks/23-DNTAVh4F.js')),
			__memo(() => import('./chunks/24-tfwWYMS4.js')),
			__memo(() => import('./chunks/25-BckDWCpN.js')),
			__memo(() => import('./chunks/26-Bd-h6uwm.js')),
			__memo(() => import('./chunks/27-BLDae7Ep.js')),
			__memo(() => import('./chunks/28-C9Iq0Qec.js')),
			__memo(() => import('./chunks/29-kolv9cNo.js')),
			__memo(() => import('./chunks/30-UJbkqrNQ.js')),
			__memo(() => import('./chunks/31-ER_8YDzP.js')),
			__memo(() => import('./chunks/32-CrBG4eT6.js')),
			__memo(() => import('./chunks/33-BbDPtpcr.js')),
			__memo(() => import('./chunks/34-0ixtj8Yq.js')),
			__memo(() => import('./chunks/35-Bh568eDi.js')),
			__memo(() => import('./chunks/36-B4JmMp_4.js')),
			__memo(() => import('./chunks/37-Cl2u8DY8.js')),
			__memo(() => import('./chunks/38-E4JkGtoQ.js')),
			__memo(() => import('./chunks/39-CM6g7ZCY.js')),
			__memo(() => import('./chunks/40-_2Mt1a8n.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-D01UFm8I.js'))
			},
			{
				id: "/auth",
				pattern: /^\/auth\/?$/,
