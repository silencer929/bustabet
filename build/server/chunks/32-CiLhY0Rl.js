...
var load = async ({ params }) => {
	const config = SPORT_KEY_MAP[params.sport ? params.sport.toLowerCase() : ""];
	if (!config || !config.key) throw error(404, "Sport category not found");
