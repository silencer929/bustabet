...
function _page($$renderer, $$props) {
	$$renderer.component(($$renderer) => {
		...
		$$renderer.push(`<!----></div></div> <div class="rounded-2xl border border-neutral-800 bg-neutral-900/40 p-6 text-center space-y-4"><span class="text-[10px] font-black tracking-widest text-neutral-500 uppercase">${escape_html(data.game.league)}</span> <div class="flex items-center justify-between max-w-xs mx-auto"><span class="text-sm font-black text-neutral-200">${escape_html(data.game.homeTeam)}</span> <span class="text-xs font-black tracking-widest text-red-500 uppercase px-3 py-1 bg-neutral-950 border border-neutral-800 rounded-full">VS</span> <span class="text-sm font-black text-neutral-200">${escape_html(data.game.awayTeam)}</span></div> <div class="text-[10px] font-bold text-neutral-500 flex items-center justify-center gap-1">`);
...
//# sourceMappingURL=_page.svelte-vJpEd3xf.js.map
