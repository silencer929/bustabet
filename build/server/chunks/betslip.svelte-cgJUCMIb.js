...
var BetSlipStore = class {
	...
	#totalOdds = derived(() => this.selections.length > 0 ? Number(this.selections.reduce((acc, curr) => acc * curr.odds, 1).toFixed(2)) : 0);
	get totalOdds() {
...
export { betslip as b };
//# sourceMappingURL=betslip.svelte-cgJUCMIb.js.map
