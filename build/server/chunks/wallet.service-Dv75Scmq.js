...
var WalletService = class {
	static MINIMUM_DEPOSIT = Number(private_env.MIN_DEPOSIT_AMOUNT || 200);
	...
	static async initiateMpesaDeposit(profileId, amount, phoneNumber) {
		if (amount < this.MINIMUM_DEPOSIT) throw new Error(`The minimum allowed deposit is ${this.MINIMUM_DEPOSIT}`);
	...
	static async initiateWithdrawal(profileId, amount, destination) {
		...
		await db.execute(`INSERT INTO transactions (id, profile_id, type, amount, currency, status, reference, destination) 
...
//# sourceMappingURL=wallet.service-Dv75Scmq.js.map
